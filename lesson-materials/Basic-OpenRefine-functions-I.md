...
* Click 'Choose Files'
* Locate the file called 'doaj-article-sample.csv' - this can be downloaded from [https://github.com/ostephens/mashcat-openrefine/raw/master/libcarp-wk4-data/doaj-article-sample.csv](https://github.com/ostephens/mashcat-openrefine/raw/master/libcarp-wk4-data/doaj-article-sample.csv)
* Click 'Next'
